...
namespace NorthwindWebMvc.Basic.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        private readonly ICategoryService<CategoryDto> _serviceCategory;

        //replace RepositoryDbContext with IRepositoryBase
        private readonly IRepositoryBase<Category> _repositoryBase;


        public CategoriesController(ICategoryService<CategoryDto> serviceCategory)
        {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            //return View(_repositoryBase.GetAll());
